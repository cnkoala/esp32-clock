...
void ui_Driving_screen_init(void)
{
    ...
    ui_GroupClock = lv_obj_create(ui_Driving);
    ...
    ui_SliderHour = lv_slider_create(ui_Driving);
    lv_slider_set_range(ui_SliderHour, 0, 24);
    lv_slider_set_value(ui_SliderHour, 12, LV_ANIM_OFF);
    if (lv_slider_get_mode(ui_SliderHour) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_SliderHour, 0, LV_ANIM_OFF);
    ...
    ui_SliderMin = lv_slider_create(ui_Driving);
    lv_slider_set_range(ui_SliderMin, 0, 60);
    lv_slider_set_value(ui_SliderMin, 30, LV_ANIM_OFF);
    if (lv_slider_get_mode(ui_SliderMin) == LV_SLIDER_MODE_RANGE)
        lv_slider_set_left_value(ui_SliderMin, 0, LV_ANIM_OFF);
    ...
    ui_GroupHeader = lv_obj_create(ui_Driving);
    ...
    ui_GroupMinute = lv_obj_create(ui_Driving);
    ...
    ui_GroupHour = lv_obj_create(ui_Driving);
    ...
    ui_GroupDate = lv_obj_create(ui_Driving);
